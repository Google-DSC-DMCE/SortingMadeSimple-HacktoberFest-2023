...
import InsertionSortLogo from "../images/bubble-sort-logo.png";
...
const InsertionSort = () => {
  ...
  const performInsertionSort = (arr) => {
  ...
  const handleClick = async () => {
    if (alreadySorted) {
      const sortedArr = await performInsertionSort(arr);
      setArr(sortedArr);
      setAlreadySorted(false);
    } else {
      if (inputArr) {
        const sortedArr = await performInsertionSort(
